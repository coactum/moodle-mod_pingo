...
/**
 * The PINGO survey created event for mod_pingo.
 *
 * @package   mod_pingo
...
class pingo_survey_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpingosurveycreated', 'mod_pingo');
    }
    ...
    public function get_description() {
        return "The user with the id '$this->userid' has created a survey in the PINGO session '$this->objectid
