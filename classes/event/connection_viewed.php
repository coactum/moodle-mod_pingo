...
/**
 * The connection viewed event for mod_pingo.
 *
 * @package   mod_pingo
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class connection_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventconnectionviewed', 'mod_pingo');
    }
    ...
    public function get_description() {
        return "The user with the id '$this->userid' has viewed the connection with the id '$this->objectid
